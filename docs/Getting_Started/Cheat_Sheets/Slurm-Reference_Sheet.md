...
| `--hint` | `#SBATCH --hint=nomultithread` | Disables [simultaneous multithreading (SMP)](../../Software/Parallel_Computing/Simultaneous_Multithreading.md), be aware that this will significantly change how your job is defined. |
