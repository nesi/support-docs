...
The only way to get the full context, is to compare walltime performance between jobs at different scale. See [Job Scaling](../Your_First_Job/Job_Scaling_Ascertaining_job_dimensions.md) for more details.
