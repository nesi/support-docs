...
- _REANNZ Information_ - is any non-public information created or managed by REANNZ, but does not include User Information.
- _REANNZ HPC Systems_ - Any system that stores, processes, or transmits REANNZ Information or User Information
- _Project Owner_ - The individual responsible for and accountable for User Information contained within a project.
- _Software_ - applications, services, operating systems, web applications, databases, or other tools used on REANNZ HPC Systems
