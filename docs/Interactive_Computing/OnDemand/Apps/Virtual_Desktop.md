...
![Click the sidebar tab on the left edge of the Virtual Desktop](../../../assets/images/Virtual_Desktop_via_OOD_on_NeSI_0.png)

Then click the clipboard icon to open the **Clipboard** panel, and paste your text into it.

![The Clipboard panel open in the VNC sidebar](../../../assets/images/Virtual_Desktop_via_OOD_on_NeSI_1.png)
