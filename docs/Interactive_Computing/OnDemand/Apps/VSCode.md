...
Mahuika supports the use of [VS Code](https://code.visualstudio.com/) for interactive computing.
VS Code can be a useful tool for developing code with support for many languages including debugging.

## Accessing VS Code on Mahuika

VS Code at Mahuika can be accessed via [Mahuika OnDemand](https://ondemand.nesi.org.nz/) and launching the VS Code application there.

## VS Code user interface

The VS Code application allows you to access interactive computing with Mahuika via [VS Code for Web](https://code.visualstudio.com/docs/setup/vscode-web). This provides a browser-based VS Code experience including the use of most VS Code extensions and debugging tools.
...
The Mahuika OnDemand deployment of VS Code does not support all VS Code extensions. Supported extensions can be found in the [Open VSX Registry](https://open-vsx.org/?sortBy=relevance&sortOrder=desc).
