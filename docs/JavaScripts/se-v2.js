(function () {
    StatusPage = "undefined" == typeof StatusPage ? {} : StatusPage, StatusPage.page = function (e) {
        if (e = e || {}, !e.page) throw new Error("A pageId is required to initialize.");
        ...
        var s = [], r = { sms: "email_sms", webhook: "endpoint" };
        for (var o in e) if ("to_sentence" !== o) {
            var i = o;
            o = o in r ? r[o] : o;
            var a = t ? t + "[" + o + "]" : o, n = e[i];
        ...
        var t = e.path, s = e.method || "GET", r = e.success || null, o = e.error || this.error,
            i = this.host_with_port_and_protocol + "/api/" + this.version + "/" + t + "." + this.format,
            a = this.createStatusPageCORSRequest(s, i);
        if (a) if (this.apiKey && (console.log("!!! API KEY IN USE - REMOVE BEFORE DEPLOYING TO PRODUCTION !!!"), console.log("!!! API KEY IN USE - REMOVE BEFORE DEPLOYING TO PRODUCTION !!!"), console.log("!!! API KEY IN USE - REMOVE BEFORE DEPLOYING TO PRODUCTION !!!"), a.setRequestHeader("Authorization", "OAuth " + this.apiKey)), a.onload = function () {
        ...
        var s = t.success || {}, r = t.error || {};
        this.executeRequestAndCallbackWithResponse({ path: e, success: s, error: r, method: "GET" })
        ...
        var r = t.success || {}, o = t.error || {};
        this.executeRequestAndCallbackWithResponse({ data: s, path: e, success: r, error: o, method: "POST" })
        ...
        var r = t.success || {}, o = t.error || {};
        this.executeRequestAndCallbackWithResponse({ data: s, path: e, success: r, error: o, method: "DELETE" })
