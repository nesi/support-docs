            ...
            htmlContent += `
                <div class="feed-item">
                    ...
                    <span class="md-icon" title="Date">
                        ...
                        <span class="git-revision-date-localized-plugin git-revision-date-localized-plugin-date">${f.date.toLocaleDateString()} via <a target="_self"  href="${f.channelUrl}">${f.channel}</a></span>
                    </span>
                    </span>
                    </div>
                </div>
