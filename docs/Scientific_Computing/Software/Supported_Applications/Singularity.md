...
[//]:./Singularity.md> (APPS PAGE BOILERPLATE START)
{% set app_name = page.title | trim %}
{% set app = applications[app_name] %}
{% include "partials/app_header.html" %}
[//]:./Singularity.md> (APPS PAGE BOILERPLATE END)
...
[shared../../Data_Management/File_Systems_and_Quotas/NeSI_File_Systems_and_Quotas.md../../Storage/File_Systems_and_Quotas/NeSI_File_Systems_and_Quotas.md../../Data_Management/File_Systems_and_Quotas/NeSI_File_Systems_and_Quotas.md
...
Specific instructions are provided in a dedicated support page [Build an../HPC_Software_Environment/Build_an_Apptainer_container_on_a_Milan_compute_node.md../../Scientific_Computing/HPC_Software_Environment/Build_an_Apptainer_container_on_a_Milan_compute_node.md
...
- Copying the image file from your local computer with basic file
    ...
    [Moving files to/from the cluster](../../Data_Management/Moving_files_to_and_from_the_cluster.md)
    and [Data Transfer using Globus](../../Data_Management/Data_Transfer_Services/Data_Transfer_using_Globus_V5.md)(if you have a large container) for details
...
If your Slurm job has requested access to an NVIDIA GPU (see [GPU use on../Running_Jobs_on_Maui_and_Mahuika/GPU_use_on_NeSI.md../../Scientific_Computing/Running_Jobs_on_Maui_and_Mahuika/GPU_use_on_NeSI.md
...
Slurm jobs. Please refer to our [SLURM: Reference../../Getting_Started/Cheat_Sheets/Slurm-Reference_Sheet.md
