...
the login node, otherwise use of an [slurm interactive../Running_Jobs_on_Maui_and_Mahuika/Slurm_Interactive_Sessions.md
...
ANSYS-EM jobs can be submitted through a slurm script or by [interactive../Running_Jobs_on_Maui_and_Mahuika/Slurm_Interactive_Sessions.md
session](../../Scientific_Computing/Running_Jobs_on_Maui_and_Mahuika/Slurm_Interactive_Sessions.md).
