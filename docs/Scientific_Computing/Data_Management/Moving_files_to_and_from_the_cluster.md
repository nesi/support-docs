...
Find more information on [the NeSI Filesystem](./File_Systems_and_Quotas/NeSI_File_Systems_and_Quotas.md).

## Using the Jupyter interface

The [Jupyter interface](../Interactive_Computing/Interactive_computing_using_Jupyter/Jupyter_on_NeSI.md)
...
!!! prerequisite
    Have SSH setup as described in [Standard Terminal Setup](../Getting_Started/Terminal_Setup/Standard_Terminal_Setup.md)
...
!!! note
    - This will only work if you have set up aliases as described in
      [Terminal Setup](../Getting_Started/Terminal_Setup/Standard_Terminal_Setup.md).
...
!!! prerequisite
    [MobaXterm Setup Windows](../Getting_Started/Terminal_Setup/MobaXterm_Setup_Windows.md)
...
(provided
[Windows_Subsystem_for_Linux](../Getting_Started/Terminal_Setup/Windows_Subsystem_for_Linux_WSL.md)
is enabled).

## WinSCP

!!! prerequisite
    [WinSCP-PuTTY Setup Windows](../Getting_Started/Terminal_Setup/WinSCP-PuTTY_Setup_Windows.md)
...
[Data_Transfer_using_Globus_V5](./Data_Transfer_Services/Data_Transfer_using_Globus_V5.md).
