...
`cuDNN/8.0.2.39-CUDA-11.0.2` module:

    module load cuDNN/8.0.2.39-CUDA-11.0.2  # for Tensorflow 2.4 and 2.5
...
> ### Note about Māui Ancillary Nodes {#prerequisites}
>
...
 **If you have been granted access** to the A100 GPU cards, here are the
recommended options to run TensorFlow:
