...
[![Arm MAP
main](mkdocs_repo/includes/images/ARM_MAP_main.png)](https://nesi.github.io/perf-training/python-scatter/images/ARM_MAP_main.png)

Click on “PROFILE”.

![MAP\_profile\_python.PNG](mkdocs_repo/includes/images/MAP_profile_python.PNG)
...
[![example-map-scatter](mkdocs_repo/includes/images/ARM_MAP_scatter_mpi.png)](https://nesi.github.io/perf-training/python-scatter/images/ARM_MAP_scatter_mpi.png)
...
[![example-map-scatter\_CPU](mkdocs_repo/includes/images/ARM_MAP_scatter_mpi_CPU.png)](https://nesi.github.io/perf-training/python-scatter/images/ARM_MAP_scatter_mpi_CPU.png)
