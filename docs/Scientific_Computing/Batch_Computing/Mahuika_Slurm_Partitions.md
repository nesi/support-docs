...
<td rowspan=2><a href="../../Scientific_Computing/Batch_Computing/Milan_Compute_Nodes.md">Jobs using Milan Nodes</a></td>
</tr>
<td>8</td>
<td>256</td>
<td>3800 MB</td>
...
<td>64</td>
<td>Part of
<a href="../../Scientific_Computing/Batch_Computing/Milan_Compute_Nodes.md">Milan Nodes</a>. See below.</td>
</tr>
</tbody>
</table>
...
See [GPU use on NeSI](../../Scientific_Computing/Batch_Computing/GPU_use_on_NeSI.md)
...
- Explicitly specify the partition to access them, with
    `--partition=hgx`.
- Hosting nodes are Milan nodes. Check the [dedicated support page](../../Scientific_Computing/Batch_Computing/Milan_Compute_Nodes.md)
