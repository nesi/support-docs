...
!!! prerequisite
    Have your [connection to the NeSI cluster](../Terminal_Setup/Standard_Terminal_Setup.md) configured
...
described in [Standard Terminal Setup](../Terminal_Setup/Standard_Terminal_Setup.md).

**Remote Port:** The port number you will use on the remote machine (in
this case the NeSI cluster)
!!! note
    The following examples use aliases as set up in [standard terminal setup](../Terminal_Setup/Standard_Terminal_Setup.md).
...
!!! tip "What Next?"
    -   Using
        [JupyterLab](../../Software/Supported_Applications/JupyterLab.md) on the cluster.
    -   [Paraview](../../Software/Supported_Applications/ParaView.md)
