...
| `--partition`  | `#SBATCH --partition=milan`              | Specified job[partition](../../Batch_Computing/Running_Jobs_on_Maui_and_Mahuika/Mahuika_Slurm_Partitions.md). |
...
| `--ntasks`          | ``#SBATCH --ntasks=2 ``          | Will start 2 [MPI](../../Parallel_Computing/Parallel_Execution.md) tasks.                                           |
| `--ntasks-per-node` | `#SBATCH --ntasks-per-node=1` | Will start 1 task per requested node.                                                                                   |
| `--cpus-per-task`   | `#SBATCH --cpus-per-task=10`  | Will request 10 [*logical* CPUs](../../Batch_Computing/Running_Jobs_on_Maui_and_Mahuika/Hyperthreading.md) per task. |
...
| `--hint` | `#SBATCH --hint=nomultithread` | Disables [hyperthreading](../../Batch_Computing/Running_Jobs_on_Maui_and_Mahuika/Hyperthreading.md), be aware that this will significantly change how your job is defined. |
