...
![Plot1](Multithreading_Scaling_Example.png){ width=47% } ![Plot2](Multithreading_Scaling_Example_0.png){ width=47% }
...
![TvC-MT.png](Multithreading_Scaling_Example_1.png){ width=47% } ![TvL2C-MT.png](Multithreading_Scaling_Example_2.png){ width=47% }
