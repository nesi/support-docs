...
![Plot1](../Mahuika_Cluster/Next_Steps/Multithreading_Scaling_Example.png){ width=47% } ![Plot2](../Mahuika_Cluster/Next_Steps/Multithreading_Scaling_Example_0.png){ width=47% }
...
![TvC-MT.png](../Mahuika_Cluster/Next_Steps/Multithreading_Scaling_Example_1.png){ width=47% } ![TvL2C-MT.png](../Mahuika_Cluster/Next_Steps/Multithreading_Scaling_Example_2.png){ width=47% }
...
![](../Mahuika_Cluster/Next_Steps/Multithreading_Scaling_Example_3.png)
