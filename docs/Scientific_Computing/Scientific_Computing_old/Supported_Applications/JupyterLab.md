...
!!! warning
     ...
     Follow this link for [more../Interactive_computing_using_Jupyter/Jupyter_on_NeSI.md
...
!!! tips
     -   MobaXterm has an internal terminal which acts like a linux
         terminal and can be configured as described in the [Standard../Terminal_Setup/Standard_Terminal_Setup.md
         Terminal
