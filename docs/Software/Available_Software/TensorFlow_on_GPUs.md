...
!!! tip "See also"
     ...
     -   To run TensorFlow on CPUs instead, have a look at our article
         [TensorFlow on../Software_Catalogue/TensorFlow_on_CPUs.md../Software_Catalouge/TensorFlow_on_CPUs.md
...
TensorFlow is available on Mahuika as an [environment../../Getting_Started/Submitting_A_Job/The_HPC_environment.md../../Getting_Started/Next_Steps/The_HPC_environment.md
