...
| ------------- | ----------- | --------------- | ------------- | ------- |
|[NeSI HPC storage](https://app.globus.org/file-manager?origin_id=3064bb28-e940-11e8-8caa-0a1d4c5c824a) | NeSI Globus Endpoint, located at Tamaki Data Centre | File-sharing and transferring files to/from NESI HPC and storage facilities. | [Quickstart guide]((https://docs.nesi.org.nz/Storage/Data_Transfer_Services/Globus_Quick_Start_Guide/)) | {% include "partials/support_request.html" %} |
