...
!!! warning
    We are currently in the process of migrating to our new [new long-term storage platform, Freezer](https://www.nesi.org.nz/case-studies/deeper-dive-nesis-platform-refresh-part-1) That means no new Nearline allocation are currently being granted, and to support our transition to Freezer, we’re scheduling a Nearline service outage starting on Monday 14 April. We expect that data currently stored in Nearline will be inaccessible for about 2 weeks from this date. If you have an urgent need to write or recall data beyond 11 April, contact NeSI Support. [You can find more details regarding the migration to Freezer on our announcement page](https://docs.nesi.org.nz/General/Announcements/update_to_nearline_service/).
