...
[our article on allocation classes](Allocation_classes.md)
...
[lower fairshare](Fair_Share_How_jobs_get_prioritised.md),
...
[Fair Share](Fair_Share_How_jobs_get_prioritised.md)
...
is two
(see [Hyperthreading](Hyperthreading.md) for
details). Therefore:
