...
1. In `File Manager`, click on the file or folder you which to share and click `Share`:
    ![Globus_Share_Collections_1.png](../../assets/images/Globus_Share_Collections_1.png)
2. In the `Guest Collections` page that appears, click `Add Guest Collection`:
    ![Globus_Share_Collections_2.png](../../assets/images/Globus_Share_Collections_2.png)
3. In the next page that appears, Fill in the details about the guest collection and then
    ...
    ![Globus_Share_Collections_3.png](../../assets/images/Globus_Share_Collections_3.png)

## How to share a share collection

1. In the `Collections` tab, click on the `Shareable By You` tab and click on the collection
    you wish to share:
    ![Globus_Share_Collections_4.png](../../assets/images/Globus_Share_Collections_4.png)
2. In the `Permissions` tab, click `Add Permissions - Share With`:
    ![Globus_Share_Collections_5.png](../../assets/images/Globus_Share_Collections_5.png)
3. Enter the email address of the person who you wish to share your data with, allow
    ...
    data *via* Globus:
    ![Globus_Share_Collections_6.png](../../assets/images/Globus_Share_Collections_6.png)
...
2. In the `Permissions` tab, open up the `Path` window and click the bin button of the user(s)
    ...
    ![Globus_Share_Collections_7.png](../../assets/images/Globus_Share_Collections_7.png)
...
2. In the `Overview` tab, click the `Delete Collection` button:
    ![Globus_Share_Collections_8.png](../../assets/images/Globus_Share_Collections_8.png)
3. Click the `Delete Collection` button:
    ![Globus_Share_Collections_9.png](../../assets/images/Globus_Share_Collections_9.png)
