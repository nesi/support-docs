...
2. During your installation you will be asked to `Log In`. Login using your Globus
   ...
   account.
   ![Globus\_Connect\_Personal\_Login\_Screen.png](../../assets/images/Globus_Connect_Personal_Login_Screen.png)

3. You will be required to click `Allow` to connect your computer to Globus.
    ![Globus\_Connect\_Personal\_Allow.png](../../assets/images/Globus_Connect_Personal_Allow.png)
...
4. Back in your Globus Connect Personal Setup screen, give a name for your computer
    ...
    ![Globus\_Connect\_Personal\_Collection\_Name.png](../../assets/images/Globus_Connect_Personal_Collection_Name.png)
...
5. Your computer will now be saved in Globus as a Globus endpoint. Back in the Globus
    ...
    ![Globus\_Connect\_Personal\_Collection\_on\_Site.png](../../assets/images/Globus_Connect_Personal_Collection_on_Site.png)

See the [Move Files With Globus](./Move_Files_With_Globus.md)
