...
- Changes to system status are reported via our [System Status page](https://status.nesi.org.nz/ "https://status.nesi.org.nz/").
    ...
    unplanned outages sent straight to your inbox — see [how to sign up for status notifications](../Getting_Started/System_Status.md).

- [Consult our User Documentation](../index.md) pages
