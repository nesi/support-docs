...
- whether your software can run on a [NeSI HPC](../../../Scientific_Computing/The_NeSI_High_Performance_Computers/index.md),
...
project's next allocation will be from another of the [allocation../../../General/NeSI_Policies/Allocation_classes.md
classes](../../General/NeSI_Policies/Allocation_classes.md).

The [How Applications are Reviewed](../Access/How_we_review_applications.md) section
